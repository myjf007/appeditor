...
AppEdit.prototype = {
	...
	bytext : function($val) {
		...
		console.log(hidden);
		return itemstart + " text-model-wrapper " + itemstart_append +  "<div class='moni-textarea ng-binding' data-id=0 ng-bind-html='htmlDecode(module.text)'>" + $val + '</div>' + "<textarea id='textareaNumber0' class='textarea ng-pristine ng-valid ng-not-empty ng-touched' ng-class='txt-show-area' ng-blur='noEdit($index)' ng-mousedown='stopPro($event)' ng-model='module.text'>" + $val + "</textarea>" + hidden + itemend;
	},
	textafter : function() {
	...
	set_top : function(current) {
		...
		if(current) {
			...
			var top = $(self.id + ".diary-list").height() - 70;	
		}
